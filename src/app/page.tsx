    ...
    <>
      ...
      <section className="bg-forest dark:bg-dark-surface">
        <div className="mx-auto max-w-5xl px-6 py-24 text-center md:py-32">
          <h1 className="font-serif text-5xl font-bold tracking-tight text-cream md:text-6xl lg:text-7xl dark:text-dark-text">
            Fallow Ground
          </h1>
          ...
          <p className="mt-1 text-sm tracking-wider text-cream/60 dark:text-dark-text-muted/60">
            &mdash; Hosea 10:12
          </p>
        </div>
      </section>
      ...
      {/* Featured Scripture */}
      <section className="bg-cream dark:bg-dark-surface">
        <div className="mx-auto max-w-3xl px-6 py-16 text-center md:py-20">
          ...
          <cite className="mt-6 block text-sm tracking-wider text-gold not-italic dark:text-dark-gold">
            Psalm 63:5–8 (NKJV)
          </cite>
        </div>
      </section>
      ...
      <section className="bg-cream dark:bg-dark-surface">
        <div className="mx-auto max-w-3xl px-6 py-16 md:py-20">
          ...
          <p className="mt-4 leading-relaxed text-dark-muted dark:text-dark-text-muted">
            Fallow Ground exists to call the church back to the deep things of
